...
` as (string | null),
    ...
    AI_CONCURRENCY: 8,
    AI_BUDGET_MS: 300000, // safety valve only: max wait for full scoring of one segment (fail-open past it)
    AI_PAUSE_GATE: true, // pause the video immediately (with overlay) until ALL danmaku are judged
